...
Generated output is written to **../apps/generated/js** (lexers/, parsers/). Generated files (under apps/generated/js/) import from `../../../generators/js/runtime/index.js`, so run from repo root or ensure that path resolves.
