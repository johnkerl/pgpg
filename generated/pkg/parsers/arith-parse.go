...
var ArithParserActions = map[int]map[tokens.TokenType]ArithParserAction{
	0: {
		tokens.TokenType("int_literal"): {kind: ArithParserActionShift, target: 4},
	},
	1: {
	...
	2: {
		...
		tokens.TokenType("modulo"): {kind: ArithParserActionShift, target: 8},
