...
```bash
# Build everything (manual, generator, apps/generated output under apps/go/generated & apps/jsons, apps/go) and run tests
make
make -C manual test
...
make -C apps/generated  # Generate lexers/parsers (output: apps/go/generated, apps/jsons)
make -C apps/go         # Build CLI runner tools

# Format code
make -C manual fmt
make -C generators/go fmt
make -C apps/generated fmt  # Go in apps/go/generated
make -C apps/go fmt
