...
Generated output is written to **../generated_py** (lexers/, parsers/). Use `PYTHONPATH=generator_py` when running codegen so that templates and runtime are found; when running generated code, use `PYTHONPATH=generator_py:generated_py`.
