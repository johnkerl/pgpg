...
var parserMakerTable = map[string]parserInfoT{
	...
	"g:pemdas-plain":        {run: runGeneratedPEMDASParser, help: "Generated arithmetic parser from generated/bnfs/pemdas-plain.bnf."},
	"g:pemdas": {run: runGeneratedPEMDASHintedParser, help: "Generated arithmetic parser with AST hints from generated/bnfs/pemdas.bnf."},
